...
def RoundTripRoadTrip(startLoc, LocFile, EdgeFile, maxTime, x_mph, resultFile):
    solver = UtilityDrivenSolver(locFilePath=LocFile, edgeFilePath=EdgeFile, startLoc=startLoc, goal=startLoc, resultFilePath=resultFile, maxTime=maxTime, x_mph=x_mph)
    solver.solve()
...
def main():
    ...
    RoundTripRoadTrip(start, locFilePath, edgeFilePath, maxTime, x_mph, resultFilePath)
